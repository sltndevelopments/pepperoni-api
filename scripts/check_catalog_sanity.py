...
TYPES = [
    ("в тесте", "сосиска в тесте"),
    ("пепперони", "пепперони"),
    ("казылык", "казылык"),
    ("сервелат", "сервелат"),
    ("варёно-копч", "варёно-копчёная"),
    ("варено-копч", "варёно-копчёная"),
    ("в/к", "варёно-копчёная"),
    ("полукопчен", "полукопчёная колбаса"),
    ("варен", "варёная колбаса"),
    ("сосиск", "сосиски"), ("сардельк", "сардельки"), ("котлет", "котлета"),
    ("ветчин", "ветчина"), ("сервелат", "сервелат"),
