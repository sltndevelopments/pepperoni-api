...
.hero__video{{margin:28px auto 0;max-width:860px;border-radius:12px;overflow:hidden;box-shadow:0 12px 40px rgba(0,0,0,.28);aspect-ratio:16/9;background:#0a2e16}}
.hero__video video{{display:block;width:100%;height:100%;object-fit:cover}}
