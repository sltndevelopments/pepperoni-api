...
.hero-video{{background:#111;line-height:0}}
.hero-video video{{display:block;width:100%;height:auto;aspect-ratio:16/9;object-fit:cover;max-height:min(72vh,720px)}}
...
<section class="hero-video" aria-label="Видео производства">
  <video autoplay muted loop playsinline preload="metadata" poster="/videos/hero-ru-poster.jpg" aria-label="Производство халяль продукции Казанские Деликатесы">
    <source src="/videos/hero-ru.mp4" type="video/mp4">
  </video>
</section>
...
<section class="hero-video" aria-label="Production video">
  <video autoplay muted loop playsinline preload="metadata" poster="/videos/hero-en-poster.jpg" aria-label="Kazan Delicacies halal production">
    <source src="/videos/hero-en.mp4" type="video/mp4">
  </video>
</section>
