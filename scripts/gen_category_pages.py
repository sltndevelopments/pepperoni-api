...
{clarify}
  ...
  <section class="case-section" style="margin-top:28px">
    <h2>{t['h_case']}</h2>
    <p style="font-size:.95rem;line-height:1.6;color:#333">{t['case']}</p>
  </section>
...
PAGES = [
    {
        ...
        "subtitle": "Казанские Деликатесы · халяль-производство, Казань",
        ...
        "intro": "Сосиски и сардельки халяль — натуральные, без ГМО, из охлаждённого говяжьего и куриного мяса. Производим в Казани по стандартам ХАССП / ISO 22000. Каждая партия сопровождается халяль-сертификатом ДУМ РТ.",
        "features": [
            ...
            "Оптовые поставки от одной паллеты (сборная возможна), доставка по России",
        ],
        "faq_pairs": [
            ...
            ("Можно ли заказать сосиски оптом?", "Да, минимальный заказ — одна паллета (сборная из разных позиций возможна). Оформите заявку по email info@kazandelikates.tatar или по телефону +7 987 217-02-02. Предоставляем прайс-лист и образцы."),
    ...
    },
    {
        ...
        "features": [
            ...
            "Оптовые поставки от одной паллеты (сборная возможна), доставка по России и СНГ",
        ],
        "faq_pairs": [
            ...
            ("Как оформить оптовый заказ?", "Напишите на info@kazandelikates.tatar или позвоните +7 987 217-02-02. Минимальный заказ — одна паллета (сборная возможна), объём кратно паллете. Доставляем по всей России и СНГ."),
        ],
        "related_links": [
    ...
    },
    {
        ...
        "features": [
            ...
            "Оптом от одной паллеты (сборная возможна), сроки доставки согласуем",
        ],
        "faq_pairs": [
            ...
            ("Как купить ветчину оптом?", "Пишите на info@kazandelikates.tatar или звоните +7 987 217-02-02. Минимальный заказ — одна паллета (сборная возможна); цена считается за паллету, EXW Казань."),
        ],
        "related_links": [
    ...
    },
    {
        ...
        "features": [
            ...
            "Оптом от одной паллеты (сборная возможна), доставка по России и СНГ",
        ],
        "faq_pairs": [
    ...
    },
    {
        ...
        "features": [
            ...
            "Оптом от одной паллеты (сборная возможна), доставка по России",
        ],
        "faq_pairs": [
            ...
            ("Можно ли купить вареную колбасу оптом?", "Да, минимальный заказ — одна паллета (сборная возможна). Пишите на info@kazandelikates.tatar или звоните +7 987 217-02-02."),
    ...
    },
    {
        ...
        "faq_pairs": [
            ...
            ("Как заказать оптом?", "Email info@kazandelikates.tatar или +7 987 217-02-02. Минимальный заказ — одна паллета (сборная возможна)."),
        ],
        "related_links": [
            ("Сосиски для хот-догов", "/sosiski-dlya-hotdog/"),
            ("Пепперони для HoReCa", "/pepperoni-dlya-horeca"),
    ...
    },
    {
        ...
        "faq_pairs": [
            ...
            ("Можно ли заказать выпечку оптом для кафе?", "Да, оптовые поставки от одной паллеты (сборная возможна). Фасовка и количество в коробе — по карточке SKU. Пишите info@kazandelikates.tatar."),
