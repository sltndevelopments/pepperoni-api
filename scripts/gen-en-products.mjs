...
.tg-order-btn{display:inline-flex;align-items:center;background:#2AABEE;color:#fff;padding:10px 24px;border-radius:8px;text-decoration:none;font-weight:600;font-size:.9rem;margin:4px 6px 4px 0;transition:background .2s}
.tg-order-btn:hover{background:#2298D6;color:#fff}
