...
OPTOM_BODY = """    <p>«Казанские Деликатесы» — производитель халяль пепперони в Татарстане. Работаем <strong>напрямую с оптовыми покупателями</strong>: дистрибьюторами, торговыми сетями, агрегаторами HoReCa. Никаких посредников — цена производителя, стабильные отгрузки, полный пакет документов.</p>
    ...
    <div class="prices-grid">
      ...
      <div class="price-card"><div class="name">Вар-коп куриный KD-014</div><div class="weight">Батон 0,8 кг</div><div class="price">457 ₽</div></div>
    </div>
    ...
    <div class="card">
      <table>
        <tbody>
          <tr><td>Минимальный заказ</td><td class="spec-value">одна паллета (сборная возможна)</td></tr>
...
PIZZA_BODY = """    <p>Пепперони — самый популярный топпинг для пиццы в России. Но для профессиональной кухни важны детали: <strong>не скручивается при запекании, держит форму, даёт равномерный цвет</strong>. Именно под эти задачи разработан халяль пепперони от «Казанских Деликатесов».</p>
    ...
    <div class="card">
      <table>
        ...
        <tbody>
          ...
          <tr><td>Батон 0,8 кг</td><td>Пиццерии со слайсером — нарезка под нужную толщину</td><td class="spec-value">457 ₽</td></tr>
    ...
    <div class="card">
      <p>Для новых партнёров доступна <strong>тестовая поставка</strong> — образцы для теста на вашей кухне согласуем индивидуально (в основном бесплатно); минимальный оптовый заказ — одна паллета, сборная возможна.</p>
    ...
    <div class="card">
      <table>
        ...
        <tbody>
          ...
          <tr><td>Нитрит натрия</td><td class="spec-value">Смотрите карточку SKU в каталоге — не у всех позиций отсутствует E250</td></tr>
...
NAREZKA_BODY = """    <p>Нарезка пепперони — самый удобный формат для пиццерий, HoReCa и розницы. Готовые слайсы правильной круглой формы, упакованные под вакуумом. Открыл — использовал. Никакого слайсера, никаких потерь.</p>
    ...
    <div class="card">
      <table>
        <tbody>
          ...
          <tr><td>Упаковок в коробке</td><td class="spec-value">уточняется у отдела продаж</td></tr>
    ...
    <div class="card">
      <table>
        <thead><tr><th>Параметр</th><th>Нарезка 0,5 кг</th><th>Батон 0,8 кг</th></tr></thead>
        <tbody>
...
PAGES = [
    {
        ...
        "desc": "Пепперони халяль оптом от производителя в Казани. Куриный KD-013 (нарезка 0,5 кг) и KD-014 (батон 0,8 кг). Private Label. EXW Казань. Экспорт в СНГ. ХАССП. Halal № 614A/2024.",
    ...
    },
    {
        ...
        "desc": "Профессиональный халяль пепперони для пиццерий. Не скручивается при 350°C. Куриный KD-013 (нарезка 0,5 кг) и KD-014 (батон 0,8 кг). Private Label для сетей. ХАССП. Halal № 614A/2024.",
        ...
        "hero_sub": "Не скручивается при 350°C. Курица (KD-013/014). Диаметр 50–55 мм.",
    ...
    },
    {
        ...
        "desc": "Пепперони халяль для HoReCa: рестораны, отели, кейтеринг, dark kitchen, фастфуд. Куриный (KD-013/014). Нарезка 0,5 кг и батон 0,8 кг. ХАССП. Halal № 614A/2024. Стабильные поставки.",
    ...
    },
    {
        ...
        "desc": "Халяль пепперони в нарезке: готовые слайсы диаметром 50–55 мм. Куриный KD-013. Вакуумная упаковка 0,5 кг. 360 суток при −18°C. ХАССП. Halal № 614A/2024.",
