...
HALAL_GUARD_RU = (
    ...
    "только факты из брендбука. Сертификаты: Халяль ДУМ РТ #614A/2024 (мясо), "
    "#884A/2025 (выпечка и готовые блюда), HACCP, ISO 22000:2018, "
    "ТР ТС 021/2011. Кошер-сертификата НЕТ. "
