...
SEGMENTS = [
    {
        ...
        "case_title": "Supply to pizzerias and foodservice distributors",
        "case_body": "Halal pepperoni ships to pizzerias and HoReCa through foodservice distributors and retail cash-and-carry. Diameter, fat and slice behaviour stay locked batch to batch. Private-label pepperoni is available under the buyer's brand — the OMPK «Aslam» contract is a <strong>separate</strong> traditional-sausage line to their recipes and does <strong>not</strong> include pepperoni.",
        "stats": [
    ...
    },
    {
        ...
        "why": [
            ...
            "<strong>In-house production</strong> in Kazan — no middleman between you and the recipe",
            "<strong>Private Label without a 10-tonne minimum</strong> — minimum order agreed per contract, depends on logistics",
    ...
    },
    {
        ...
        "description": "Halal private-label / contract manufacturing in Russia: sausages, pepperoni, hams, dumplings, Tatar pastries under your brand. Federal case: traditional «Aslam» sausages for OMPK (customer recipes, not pepperoni). Halal #614A/2024.",
        ...
        "og_description": "Recipe, casing, diameter, packaging — customisable under your brand. Federal case: «Aslam» traditional sausages for OMPK (not pepperoni).",
        ...
        "case_title": "Federal-scale case: «Aslam» traditional sausages for OMPK",
        "case_body": "We manufacture the <strong>«Aslam»</strong> traditional sausage line for <strong>OMPK JSC</strong> (Ostankino Meat Plant) to the customer's recipes and specs. This is not pepperoni and not our pepperoni SKUs — a separate contract lineup with its own names. The case shows capacity, recipe lock and document discipline at federal scale.",
        "stats": [
            ("«Aslam» / OMPK", "federal case"),
            ("By agreement", "minimum / logistics"),
        ...
        "features": [
            ...
            ("⚖️", "Minimum tier", "Minimum order agreed per contract, depends on logistics — no 10-tonne entry barrier."),
        ...
        "why": [
            ...
            "<strong>Federal-scale case</strong> — «Aslam» / OMPK traditional sausages (customer recipes, not pepperoni)",
            "<strong>No 10-tonne barrier</strong> — minimum order agreed per contract, depends on logistics",
